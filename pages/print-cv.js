...
const PrintCv = ({ cv }) => {
  ...
  return(
    <React.Fragment>
      <ButtonContainer>
        <CButton onClickFunction = { () => printjs({ printable: 'print-cv', type: 'html', header: 'CV' }) }>
          { language.print }
        </CButton>
      </ButtonContainer>
        ...
        <CvSectionsContainer>
          <CvSection>
            ...
            <CvSectionItem grey>
              ...
              <h2><strong>{ language.years }</strong></h2>
              <h2><strong>{ language.role }</strong></h2>
            </CvSectionItem>
            <Separator height = '20px' />
            { cv.workplaces?.map( ( workplace, index ) => (
              <CvSectionItem key = { index }>
                <p>{ workplace.employerName }</p>
                <p>{ workplace.startYear } - { workplace.endYear }</p>
                <p>{ workplace.role }</p>
              </CvSectionItem>
            ) ) }
          </CvSection>
          ...
          <CvSection>
            ...
            <CvSectionItem grey>
              ...
              <h2><strong>{ language.years }</strong></h2>
              <h2><strong>{ language.graduation }</strong></h2>
            </CvSectionItem>
            <Separator height = '20px' />
