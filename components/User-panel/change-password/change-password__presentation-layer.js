    ...
    <Container id = 'change-password'>
...

      {
        state.step === 1 && (
          <StageContainer>
            <Header>
              { language.userPanel.changePassword.stepOneHeader }
            </Header>
            <Separator height = '20px' />
            <div>
              <Input
            ...
            { state.isErr && (
              <>
                <Separator height = '20px' />
                <ErrMsg>
                  { language.userPanel.changePassword.stepOneErr }
                </ErrMsg>
              </>
            ) }
...

      {
        state.step === 2 && (
          <StageContainer>
            <Header>
              { language.userPanel.changePassword.stepTwoHeader }
            </Header>
            <Separator height = '20px' />
            <div>
              <Input
            ...
            { state.isErr && (
                <>
                  <Separator height = '20px' />
                  <ErrMsg>
                    { language.userPanel.changePassword.stepTwoErrTitle }:
                  </ErrMsg>
...

      {
        state.step === 3 && (
          <StageContainer>
            <Header>
              { language.userPanel.changePassword.stepThreeHeader }
            </Header>
            <Separator height = '20px' />
            <div>
              <Input
            ...
            { state.isErr && (
                <>
                  <Separator height = '20px' />
                  <ErrMsg>
                    { language.userPanel.changePassword.stepThreeErr }:
                  </ErrMsg>
                  <Separator height = '10px' />
                </>
              ) }
...

      {
        state.step === 4 && (
          <StageContainer>
            <Header>
              { language.userPanel.changePassword.stepFourTitle }
            </Header>
          </StageContainer>
        )
      }
