  ...
  return (
    <Container>
      ...
      <SortButtonsContainer>
        ...
        <SortButton onClick={() => handlers.setSortMode('date')} isActive={state.sortMode === 'date'}>
          {language.date}
        </SortButton>
        <SortButton onClick={() => handlers.setSortMode('name')} isActive={state.sortMode === 'name'}>
          {language.title}
        </SortButton>
      </SortButtonsContainer>
      ...
      <Content>
        ...
        <div>
          <Sidebar menu={getIndustries(true)} light />
        </div>
