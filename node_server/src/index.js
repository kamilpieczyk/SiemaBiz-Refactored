...
const uploadImages = multer( { storage: imageStorage, limits: { fileSize: 2*1024*1024 } } )
const uploadCompanyLogos = multer( { storage: companyLogoStorage, limits: { fileSize: 2*1024*1024 } } )
...
class App {
  ...
  getRoutes(){
    ...
    app.get( "/get-coop-ads/:company", require( "./routes/getCompaniesCoopAds" ) );
